...
# 📦 Cria automaticamente o banco e a tabela se ainda não existir
os.makedirs("banco", exist_ok=True)
if not os.path.exists("banco/usuarios.db"):
...
# 🚀 Executa na porta 10000 com host aberto para a Render
